...
CLIENT_FILES = '{}keys/ca.crt {}keys/{}.key {}keys/{}.crt'.format(OPEN_VPN_RSA, OPEN_VPN_RSA, CLIENT, OPEN_VPN_RSA,  CLIENT)                                                        

# find all tunnel based on grep open vpn directory configs                                                                                                                      
tuns = []                                                                                                                                                                       
response = os.popen('grep {} /etc/openvpn/*.conf'.format("'dev tun'"))                                                                                                              
for i in response:                                                                                                                                                              
    try:                                                                                                                                                                        
...
if NO_CHANGES:                                                                                                                                                                  
    ...
    os.system('cp -i {} {}'.format(CLIENT_FILES, OPEN_VPN_CLIENT_DIR + CLIENT + '/'))
